...
print("Starts with D:")
a = [person.name for person in humans if person.name[0] == "D" or person.name == "d" ]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [person.name for person in humans if person.name[-1] == "e" or person.name[-1] =="E"]
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")
between_c_g = ["C", "c", "D", "d","E", "e", "F", "f", "G", "g"]
c = [person.name for person in humans if person.name[0] in between_c_g]
print(c)
